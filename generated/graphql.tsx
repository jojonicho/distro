...
export const MessageDocument = gql`
  ...
  sendMessage(input: {content: $content})
    ...
    `;
export type MessageMutationFn = ApolloReactCommon.MutationFunction<MessageMutation, MessageMutationVariables>;
 ...
 * });
 */
export function useMessageMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<MessageMutation, MessageMutationVariables>) {
        return ApolloReactHooks.useMutation<MessageMutation, MessageMutationVariables>(MessageDocument, baseOptions);
      }
export type MessageMutationHookResult = ReturnType<typeof useMessageMutation>;
export type MessageMutationResult = ApolloReactCommon.MutationResult<MessageMutation>;
export type MessageMutationOptions = ApolloReactCommon.BaseMutationOptions<MessageMutation, MessageMutationVariables>;
